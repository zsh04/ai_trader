...
# Roadmap — Personal AI Trading Agent (Azure, Alpaca, MTF)

> Scope: Equities/ETFs only (to start). Azure App Service (Linux container), Azure Blob Storage, Azure Database for PostgreSQL. Alpaca broker. Session-aware operation (PRE, REG-AM, REG-MID, REG-PM, AFT). Daily watchlist with premarket scanner ($1–$10).
