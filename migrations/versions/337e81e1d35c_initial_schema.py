...
def upgrade() -> None:
    ...
    numeric = lambda precision, scale: sa.Numeric(precision, scale)
    ...
    op.create_table(
        ...
        sa.Column("symbol", sa.String(length=24), sa.ForeignKey("market.symbols.symbol"), nullable=False),
        sa.Column("vendor", sa.String(length=32), nullable=False),
        ...
        sa.Column("ingestion_ts", timestamp, nullable=False, server_default=sa.func.now()),
        schema="market",
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("filled_qty", numeric(18, 6), nullable=False, server_default=sa.text("0")),
    ...
    op.create_table(
        "fills",
        sa.Column("id", sa.BigInteger, primary_key=True, autoincrement=True),
        sa.Column("order_id", sa.String(length=64), sa.ForeignKey("trading.orders.id"), nullable=False),
        sa.Column("symbol", sa.String(length=24), sa.ForeignKey("market.symbols.symbol"), nullable=False),
        sa.Column("side", sa.String(length=8), nullable=False),
        sa.Column("qty", numeric(18, 6), nullable=False),
    ...
    op.create_table(
        "positions",
        sa.Column("symbol", sa.String(length=24), sa.ForeignKey("market.symbols.symbol"), primary_key=True),
        sa.Column("net_qty", numeric(18, 6), nullable=False),
        sa.Column("avg_price", numeric(18, 6), nullable=False),
        sa.Column("realized_pnl", numeric(18, 6), nullable=False, server_default=sa.text("0")),
        sa.Column("unrealized_pnl", numeric(18, 6), nullable=False, server_default=sa.text("0")),
    ...
    op.create_table(
        "risk_events",
        sa.Column("id", sa.BigInteger, primary_key=True, autoincrement=True),
        sa.Column("symbol", sa.String(length=24), sa.ForeignKey("market.symbols.symbol"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.BigInteger, primary_key=True, autoincrement=True),
        sa.Column("run_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("backtest.strategy_runs.id"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_at", timestamp, server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", timestamp, server_default=sa.func.now(), nullable=False),
        sa.UniqueConstraint("metric_date", "metric_name", name="uq_daily_metrics_date_name"),
        schema="analytics",
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_strategy_run_equity_run_ts", table_name="strategy_run_equity", schema="backtest")
    op.drop_table("strategy_run_equity", schema="backtest")

    op.drop_index("ix_strategy_run_metrics_run_metric", table_name="strategy_run_metrics", schema="backtest")
    op.drop_table("strategy_run_metrics", schema="backtest")

    op.drop_index("ix_strategy_runs_strategy_started", table_name="strategy_runs", schema="backtest")
    op.drop_table("strategy_runs", schema="backtest")

    op.drop_index("ix_risk_events_symbol_triggered", table_name="risk_events", schema="trading")
    ...
    op.drop_index("ix_corporate_actions_symbol_effective", table_name="corporate_actions", schema="market")
    op.drop_table("corporate_actions", schema="market")

    op.drop_index("ix_price_snapshots_symbol_ts", table_name="price_snapshots", schema="market")
